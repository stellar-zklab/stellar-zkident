...
// exact byte layout contracts/zk_verifier/src/groth16.rs expects — identical conversion to
// stellar-zkstream's circuits/convert_to_soroban.mjs, since this reuses that same contract:
...
convert("build/age_proof", "age_proof");
convert("build/kyc_tier_proof", "kyc_tier_proof");
convert("build/membership_proof", "membership_proof");
